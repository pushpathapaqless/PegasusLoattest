...
class AddWalkInUsingWebKioskWithCurrentTimeBeingInAvailabilityIntervalNoOtherWalkInForCurrentResource extends Simulation {
  ...
  private val scn = scenario("AddWalkInUsingWebKioskWithCurrentTimeBeingInAvailabilityIntervalNoOtherWalkInForCurrentResource")
    .exec(
      http("request_0")
      ...
      http("request_2")
        ...
        .resources(
          ...
          http("request_4")
            ...
            .headers(headers_4)
            .body(RawFileBody("addwalkinusingwebkioskwithcurrenttimebeinginavailabilityintervalnootherwalkinforcurrentresource/0004_request.json"))
        )
    )
    .pause(3)
    .exec(
      ...
      http("request_6")
        ...
        .resources(
          http("request_7")
            ...
            .headers(headers_4)
            .body(RawFileBody("addwalkinusingwebkioskwithcurrenttimebeinginavailabilityintervalnootherwalkinforcurrentresource/0007_request.json")),
          http("request_8")
      ...
      http("request_9")
        ...
        .resources(
          http("request_10")
            ...
            .headers(headers_4)
            .body(RawFileBody("addwalkinusingwebkioskwithcurrenttimebeinginavailabilityintervalnootherwalkinforcurrentresource/0010_request.json"))
        )
    )
    .pause(1)
    .exec(
      http("request_11")
        ...
        .resources(
          http("request_12")
            ...
            .headers(headers_4)
            .body(RawFileBody("addwalkinusingwebkioskwithcurrenttimebeinginavailabilityintervalnootherwalkinforcurrentresource/0012_request.json"))
        )
    )
